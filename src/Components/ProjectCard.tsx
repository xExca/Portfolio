...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div key={id} className="group relative w-[50vw] h-[60vh] bg-gray-300 dark:bg-gray-700 shadow-md rounded-lg overflow-hidden">
      ...
      <button
        className="absolute left-8 bottom-6 opacity-0 translate-y-3 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0 rounded h-auto w-auto p-1 text-xs  bg-white text-black shadow"
      >
        Learn more →
      </button>
    </div>
